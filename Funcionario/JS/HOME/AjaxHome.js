            ...
            bloco_main3.innerHTML += `<div class="Main_Cont3_Bloco-Chaves">
                                            ...
                                            <div class="Bloco_Chaves">
                                                    ...
                                                    <div class="arrow_right_div">
                                                        <button id="arrow_right_chaves" class="arrow_right_Predio_${element["idPredio"]}">
                                                            <i class='bx bx-chevron-right'></i>
                                                        </button>
                                                    </div>
                                                <div class="Container_Chaves_Ul">
                                                    <ul class="Bloco_Chaves_UL" id="Predio_ul_${element["idPredio"]}">
    ...
    $.get('./PHP/Gerenciamento/chave.php', function (chave) {
        ...
        predios1.forEach((predios) =>{
            chave.forEach((chaves) =>{
                    if (("Predio_ul_"+chaves['idPredio']) == predios.id){
                        predios.innerHTML += `<li class="Bloco_Chaves_LI">
                                                <div>
                                                    <input type="checkbox">
                                                </div>
                                                <div>
